...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'video ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        yt.on('end', async () => {
            ...
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, { caption: "```Z BOT UPLOADING```" });
        });
    }));
    ...
    Asena.addCommand({pattern: 'zimg ?(.*)', fromMe: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'video ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        yt.on('end', async () => {
            reply = await message.client.sendMessage(message.jid,Lang.UPLOADING_VIDEO,MessageType.text);
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, { quoted: message.data, caption: "```Z BOT UPLOADING```" });
        });
    }));
    ...
    Asena.addCommand({pattern: 'sing ?(.*)', fromMe: false, desc: Lang.SING_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.audio, {mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true});
            });
    }));
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: false, desc: Lang.ISONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: 'ᴜᴘʟᴏᴀᴅɪɴɢ ʙʏ ᴢ ʙᴏᴛ' + '.mp3', mimetype: 'audio/mpeg', quoted: message.data});
            });
    }));
    ...
    Asena.addCommand({pattern: 'ᴢimg ?(.*)', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
        ...
        Asena.addCommand({ pattern: 'num ?(.*)', fromMe: false, desc: 'owner number' }, (async (message, match) => {
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=Config.SAID_NUMBER:+94771323434\n' // WhatsApp ID + phone number
            + 'END:VCARD'
