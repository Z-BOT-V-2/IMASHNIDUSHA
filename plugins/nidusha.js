...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (therikick_var == 'true' && message.jid !== '905511384572-1616356915@g.us') {
        let regex1 = new RegExp('හුත්ති')
        let regex2 = new RegExp('වේසි')
        let regex3 = new RegExp('wesi')
        let regex4 = new RegExp('වේසි')
        ...
        let regex9 = new RegExp('kariya')
        let regex10 = new RegExp('කැරියා')
        let regex11 = new RegExp('හුත්තා')
        let regex12 = new RegExp('ponnaya')
        let regex13 = new RegExp('පොන්නයා')
        let regex14 = new RegExp('fuck')
        let regex15 = new RegExp('හුත්තා')
