...
Asena.addCommand(
  { pattern: "tts2 ?(.*)", fromMe: fm, desc: Lang.TTS_DESC },
  async (message, match) => {
    if (match == "") return;
...
Asena.addCommand(
  { pattern: "song2 ?(.*)", fromMe: true, desc: Lang.SONG_DESC },
  async (message, match) => {
...
Asena.addCommand(
  { pattern: "video2 ?(.*)", fromMe: fm, desc: Lang.VIDEO_DESC },
  async (message, match) => {
    match = !message.reply_message ? match : message.reply_message.text;
...
Asena.addCommand(
  { pattern: "yts2 ?(.*)", fromMe: true, desc: Lang.YT_DESC },
  async (message, match) => {
...
Asena.addCommand(
  { pattern: "wiki2 ?(.*)", fromMe: true, desc: Lang.WIKI_DESC },
  async (message, match) => {
    if (match === "") return await message.sendMessage(Lang.NEED_WORDS);
...
Asena.addCommand(
  { pattern: "img2 ?(.*)", fromMe: true, desc: Lang.IMG_DESC },
  async (message, match) => {
    if (match === "") return await message.sendMessage(Lang.NEED_WORDS);
